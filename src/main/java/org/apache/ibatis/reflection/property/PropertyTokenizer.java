 ...
 * eg: 在访问 "order[0].item[0].name" 时，我们希望拆分成 "order[0]"、"item[0]"、"name" 三段，那么就可以通过 PropertyTokenizer 来实现
 */
public class PropertyTokenizer implements Iterator<PropertyTokenizer> {
  ...
  public static void main(String[] args) {
    PropertyTokenizer prop = new PropertyTokenizer("order[0].item[0].name");
